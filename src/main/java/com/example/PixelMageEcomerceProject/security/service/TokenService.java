...
public class TokenService {
    ...
    private static final String PREFIX_USER_REFRESH = "user_refresh:"; // user_refresh:{email} → token (để revoke cũ khi
                                                                       // login mới)
     ...
     * KHÔNG xóa token — refresh token dùng được nhiều lần cho đến khi hết hạn hoặc
     * bị revoke
     */
    ...
    /**
     * Revoke refresh token bằng token value (dùng khi logout từ client gửi token
     * lên)
     */
